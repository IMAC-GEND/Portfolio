...
public class ResponsiveCALCULATOR extends Frame  
{  
	...
	ResponsiveCALCULATOR(String frameText)
	{  
		super(frameText);  
...
{  
	new ResponsiveCALCULATOR("Calculator - JavaTpoint");  
}  
}  
...
{  
	ResponsiveCALCULATOR cl;  
  
	MyDigitButton(int x,int y, int width,int height,String cap, ResponsiveCALCULATOR clc)  
	{  
		super(cap);  
...
{  
	...
	MyOperatorButton(int x,int y, int width,int height,String cap, ResponsiveCALCULATOR clc)  
	{  
		super(cap);  
		setBounds(x,y,width,height);  
		this.cl=clc;  
	    ...
	    try  
	        {
	    		...
	    		cl.displayLabel.setText(ResponsiveCALCULATOR.getFormattedText(tempd));
	    	}  
	...
	{  
		...
		cl.displayLabel.setText(ResponsiveCALCULATOR.getFormattedText(temp));  
...
{  
	...
	MyMemoryButton(int x,int y, int width,int height,String cap, ResponsiveCALCULATOR clc)  
	{  
		super(cap);  
		setBounds(x,y,width,height);  
		this.cl=clc;  
	...
	{  
		...
		case 'R':   
		    cl.displayLabel.setText(ResponsiveCALCULATOR.getFormattedText(cl.memValue));break;  
		case 'S':  
		    cl.memValue=0.0;  
		case '+':   
...
{  
	...
	MySpecialButton(int x,int y, int width,int height,String cap, ResponsiveCALCULATOR clc)  
	{  
		super(cap);  
		setBounds(x,y,width,height);  
		this.cl=clc;  

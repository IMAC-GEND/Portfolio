...
import java.awt.*;
public class MenuSubmenu_with_ImageIcon 
{
	public static void main(String[]args){
		...
		button1.setIcon(new ImageIcon("\"D:\\CPE Files\\BS COMPUTER ENGINEERING\\BSCpE - 3GF\\1st Semester\\CPE13 Object-Oriented Programming\\Activities\\Image Icon\\New.png\""));

...
public class FilBOOOK extends JFrame {
    ...
    public FilBOOOK() {
     ...
     // Set the icon image
      ...
      //The following command for buttons for the given list of books are the same with other class of subjects
        ...
        JButton btnLink_7 = new JButton("The Reign of Greed");
        ...
        btnLink_7.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("https://books.google.com.ph/books?id=1PxWAAAAYAAJ&printsec=frontcover&dq=Work+of+Rizal&hl=en&newbks=1&newbks_redir=1&sa=X&ved=2ahUKEwjm2f6n5cf-AhVym1YBHbtYCfsQ6AF6BAgEEAI"));
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
        ...
        JButton btnLink_6 = new JButton("Rizal's Prose and Poetry");
        ...
        btnLink_6.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("https://books.google.com/books?id=lpdfAAAAMAAJ&q=Work+of+Rizal&dq=Work+of+Rizal&hl=en&newbks=1&newbks_redir=1&printsec=frontcover&sa=X&ved=2ahUKEwjm2f6n5cf-AhVym1YBHbtYCfsQ6AF6BAgDEAI"));
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
        ...
        JButton btnLink_5 = new JButton("The Social Cancer");
        ...
        btnLink_5.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("https://books.google.com.ph/books?id=wuMsAAAAMAAJ&printsec=frontcover&dq=Work+of+Rizal&hl=en&newbks=1&newbks_redir=1&sa=X&ved=2ahUKEwjm2f6n5cf-AhVym1YBHbtYCfsQ6AF6BAgHEAI"));
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
        ...
        JButton btnLink_4 = new JButton("Rizal's Life, Works and Writings");
        ...
        btnLink_4.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("https://books.google.com/books?id=NefNZZ9ughYC&printsec=frontcover&dq=Work+of+Rizal&hl=en&newbks=1&newbks_redir=1&sa=X&ved=2ahUKEwjm2f6n5cf-AhVym1YBHbtYCfsQ6AF6BAgLEAI"));
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
        ...
        JButton btnLink_3 = new JButton("Sucesos de las Islas Filipinas");
        ...
        btnLink_3.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("https://books.google.com.ph/books?id=ym_CwQEACAAJ&dq=Work+of+Rizal&hl=en&newbks=1&newbks_redir=1&sa=X&ved=2ahUKEwjm2f6n5cf-AhVym1YBHbtYCfsQ6AF6BAgNEAI"));
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
        ...
        JButton btnLink_2 = new JButton("Friars and Filipinos");
        ...
        btnLink_2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("https://books.google.com/books?id=CBQszwEACAAJ&dq=Work+of+Rizal&hl=en&newbks=1&newbks_redir=1&sa=X&ved=2ahUKEwjm2f6n5cf-AhVym1YBHbtYCfsQ6AF6BAgFEAI"));
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
        ...
        JButton btnLink_1 = new JButton("The Indolence of the Filipino");
        ...
        btnLink_1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("https://books.google.com.ph/books?id=JJeKEAAAQBAJ&printsec=frontcover&dq=Work+of+Rizal&hl=en&newbks=1&newbks_redir=1&sa=X&ved=2ahUKEwiTqsKG5sf-AhUUjVYBHfP9AwE4ChDoAXoECA4QAg"));
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
                ...
                JButton btnLink = new JButton("Nole Me Tangere");
                ...
                btnLink.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        try {
                            Desktop.getDesktop().browse(new URI("https://books.google.com/books?id=7Hbiu3909pEC&printsec=frontcover&dq=noli+me+tangere&hl=en&newbks=1&newbks_redir=1&sa=X&ved=2ahUKEwijzvOm5sf-AhUYUd4KHfHjBJwQ6AF6BAgIEAI"));
                        } catch (Exception ex) {
                            ex.printStackTrace();
                        }
                    }
